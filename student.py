...
class studentClass:
    def __init__(self,root):
        ...
        lbl_pincode=Label(self.root,text="Pin",font=("goudy old style",15,"bold"),bg="white").place(x=500,y=220)
        txt_pincode=Entry(self.root,textvariable=self.var_pincode,font=("goudy old style",15,"bold"),bg="lightblue").place(x=560,y=220,width=120)
        ...
        btn_search=Button(self.root,text="SEARCH",font=("goudy old style",15,"bold"),bg="#2196f3",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=30)
