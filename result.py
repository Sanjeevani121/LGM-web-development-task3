...
class resultClass:
    def __init__(self,root):
        ...
        #----title----#
        title=Label(self.root,text="Add Student Results",font=("goudy old style",20,"bold"),bg="purple",fg="white").place(x=10,y=15,width=1180,height=50)
        ...
        lbl_select=Label(self.root,text="Select",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=100)
        ...
        btn_search=Button(self.root,text="SEARCH",font=("goudy old style",15,"bold"),bg="#2196f3",fg="white",cursor="hand2",command=self.search).place(x=500,y=100,width=100,height=30)
        ...
        #---image---#
        self.bg_img=Image.open("images/result image 4.jpg")
